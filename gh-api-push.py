...
用法:  GH_TOKEN=ghp_xxx python gh-api-push.py [目录] [仓库] [分支] [提交信息]
缺省:  当前目录  liuxuanbing10/campus-forum  main  "chore: update"
"""
...
if not TOKEN:
    ...
    print("   用法: GH_TOKEN=ghp_xxx python gh-api-push.py [目录] [repo] [分支] [提交信息]")
    sys.exit(1)
...
COMMIT_MSG = sys.argv[4] if len(sys.argv) > 4 else "chore: update via gh-api-push"
BASE_URL = f"https://api.github.com/repos/{REPO}"

SKIP_DIRS = {'node_modules', '.git', 'dist', '__pycache__', '.venv', '.next', 'build', 'target'}
SKIP_FILES = {'package-lock.json', '.env', '.DS_Store', 'pnpm-lock.yaml', 'yarn.lock', 'gh-api-push.py'}
