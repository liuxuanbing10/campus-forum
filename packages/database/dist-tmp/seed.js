...
export async function seedData(db) {
    ...
    await db.run('INSERT INTO users (username, password_hash, display_name, is_admin) VALUES (?, ?, ?, ?)', 'admin', hash, '管理员', 1);
    ...
    const insertBoard = db.prepare('INSERT INTO boards (name, description, icon, created_by) VALUES (?, ?, ?, 1)');
